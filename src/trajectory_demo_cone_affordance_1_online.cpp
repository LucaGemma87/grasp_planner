        ...
        for (int i = 0; i < int_traj; ++i)
        {
          ...
          if (position_wrist_home[2]>position_cone[2])
           { 
            ...
            double Kp = ((double)distance_z - (double)cone.h/2 -(double)threshold_distance/4)/(double)distance_z;
            double Krot = (double)1; 
