...
{ 
  ...
  { //sleep(4);
    ...
    tf::Vector3 position_sph(X,Y,0.10);
    ...
    ROS_INFO("Orientation cyl(%f,%f,%f,%f)",orientation_sph[0],orientation_sph[1],orientation_sph[2],orientation_sph[3]);
    ...
    { 
     ...
     moveit_msgs::RobotTrajectory trajectory;
      ...
      if ((position_sphere[0] != position_wrist_home[0]) & ( position_wrist_home[2] != (double)0))
      {
       ...
       double Kp = ((double)distance_z - (double)sphere.r)/(double)distance_z;
